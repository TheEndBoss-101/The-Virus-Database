...
::
::fBE1pAF6MU+EWHreyHcjLQlHcBCKOW60OpEZ++Pv4Pq7kUwQRO46OLnSyKGdHNIc6EnrbdYb32hPi/cCAw9ZfQaieA4grGoMoGaWVw==
::YAwzoRdxOk+EWAjk
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFA9cSQGMAE+/Fb4I5/jH3OuKskEYFNQ2aprI5oaBIuwc8gXSfIQ4xUZol8kAAwNnWhu4bw04rCBHrmHl
::YB416Ek+ZW8=
::
::
...
:disable
echo [0m[ [92mINFO[0m ] [90mSTATUS [97mDISABLE LAUNCHED[0m!
if exist C:\Windows\System32\drivers\etc\rbxl_status.txt (
    echo [0m[ [92mINFO[0m ] [90mSTATUS [97mIS ACTIVE[0m!
    del C:\Windows\System32\drivers\etc\hosts
    del C:\Windows\System32\drivers\etc\rbxl_status.txt
    copy C:\Windows\System32\drivers\etc\hosts_backup C:\Windows\System32\drivers\etc\hosts
    del C:\Windows\System32\drivers\etc\hosts_backup
    goto quit
) else (
    echo [0m[ [92mINFO[0m ] [90mSTATUS [97mIS NOT ACTIVE[0m!
    cscript notactivated.vbs
    goto quit
)
